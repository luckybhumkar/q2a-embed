<?php
	...
	function option_default($option) {
		...
		case 'embed_mp3_player_code':
		    return '<object type="application/x-shockwave-flash" data="https://flash-mp3-player.net/medias/player_mp3_mini.swf" width="200" height="20"><param name="movie" value="https://flash-mp3-player.net/medias/player_mp3_mini.swf" /><param name="bgcolor" value="#000000" /><param name="FlashVars" value="mp3=$1" /></object>';
		default:
		    return null;				
	    }
